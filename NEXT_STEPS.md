...
- Prepared the deterministic 50-expression MeViS manifest for the next evaluation stage. It covers 17 multi-target, 8 motion, 1 relation, 1 temporal, and 23 single-target cases. No 50-case inference has been run yet.
- Completed all 50 candidate caches/renders. Across 109 target objects, candidate recall is `0.9358` at IoU 0.10, `0.8899` at IoU 0.30, and `0.8532` at IoU 0.50. The proposal gate passes at IoU 0.10; selector evaluation on this expanded set is next.
